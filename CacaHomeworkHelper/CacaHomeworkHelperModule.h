...
// CacaHomeworkHelperModule.h : header file
//


#include "..\include\FQEventSinkInc.h"
/////////////////////////////////////////////////////////////////////////////
// CCacaHomeworkHelperModule command target

class CCacaHomeworkHelperModule : public CCmdTarget
{
	DECLARE_DYNCREATE(CCacaHomeworkHelperModule)
	DECLARE_EVENT_RECEIVER(CCacaHomeworkHelperModule)

	CCacaHomeworkHelperModule();           // protected constructor used by dynamic creation
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCacaHomeworkHelperModule)
	public:
...
// Implementation
protected:
	virtual ~CCacaHomeworkHelperModule();

	// Generated message map functions
	//{{AFX_MSG(CCacaHomeworkHelperModule)
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_OLECREATE(CCacaHomeworkHelperModule)

	// Generated OLE dispatch map functions
	//{{AFX_DISPATCH(CCacaHomeworkHelperModule)
		// NOTE - the ClassWizard will add and remove member functions here.
	//}}AFX_DISPATCH
...
public:
	...
	HRESULT OnSkinChange2(COLORREF clrRgb);
	HRESULT OnMainPanelChange(LPCTSTR HidePanelName, HWND hHideWnd, LPCTSTR ShowPanelName, HWND hShowWnd);
	HRESULT OnCustomButtonClick(LPCTSTR ButtonName);
