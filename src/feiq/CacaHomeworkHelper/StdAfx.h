...
#define FQ_MODULE_IDENTIFIER_PLUGINFEEDBACK	_T("FeiQ.CacaHomeworkHelper")
#define FQ_MODULE_NAME_PLUGINFEEDBACK		_T("CacaHomeworkHelper")
#define FQ_MODULE_DESCRIPTION_PLUGINFEEDBACK	_T("CacaHomeworkHelper")
#define FQ_MODULE_AUTHOR_PLUGINFEEDBACK	_T("CacaSDK")

#define FQ_MODLE_CLSIDS _T("{4ce3c885-1854-44af-ba63-7a8cec4abc41}")//多个clsid之间用 | 隔开
//{{AFX_INSERT_LOCATION}}
